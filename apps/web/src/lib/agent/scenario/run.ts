...
import type { AgentEvent, AgentEventInput, CitationTarget } from "../types";

type Block =
  | { kind: "text"; id: string; text: string }
  | { kind: "table"; id: string; columns: string[]; rows: { cells: string[]; tone?: "ok" | "warn" | "bad" }[] };
...
export class RunBuilder {
  ...
  table(columns: string[], rows: { cells: string[]; tone?: "ok" | "warn" | "bad" }[]) {
