...
export const BERKAS_TYPES: BerkasType[] = [
  ...
  { id: "kuasa", label: "Kuasa", group: "Umum",
    steps: ["Intake", "Draft akta", "Penandatanganan"], stepsVerified: false },
  { id: "pendirian_yayasan", label: "Pendirian yayasan", group: "Pendirian badan usaha",
    steps: ["Intake", "Pesan nama", "Draft akta", "Penandatanganan", "SK Kemenkumham"], stepsVerified: false },
  { id: "pendirian_koperasi", label: "Pendirian koperasi", group: "Pendirian badan usaha",
    steps: ["Intake", "Rapat pendirian", "Draft akta", "Penandatanganan", "SK Kemenkop"], stepsVerified: false },
  { id: "jual_beli_saham", label: "Jual beli saham", group: "Korporasi",
    steps: ["Intake", "Uji tuntas", "Draft akta", "Penandatanganan", "Pemberitahuan AHU"], stepsVerified: false },
  { id: "pembubaran", label: "Pembubaran badan usaha", group: "Korporasi",
    steps: ["Intake", "RUPS pembubaran", "Pengumuman", "Draft akta", "Penandatanganan"], stepsVerified: false },
  { id: "aphb", label: "Pembagian hak bersama (APHB)", group: "Pertanahan (PPAT)",
    steps: ["Intake", "Pengecekan sertifikat", "Draft akta", "Penandatanganan", "Pendaftaran"], stepsVerified: false },
  { id: "tukar_menukar", label: "Tukar menukar", group: "Pertanahan (PPAT)",
    steps: ["Intake", "Cek lokasi", "Pengecekan sertifikat", "Draft akta", "Penandatanganan"], stepsVerified: false },
  { id: "perjanjian_kawin", label: "Perjanjian kawin", group: "Keluarga",
    steps: ["Intake", "Draft akta", "Penandatanganan", "Pencatatan"], stepsVerified: false },
  { id: "sewa", label: "Sewa-menyewa", group: "Umum",
    steps: ["Intake", "Negosiasi", "Draft akta", "Penandatanganan"], stepsVerified: false },
  { id: "legalisasi", label: "Legalisasi / waarmerking", group: "Umum",
    steps: ["Intake", "Pemeriksaan", "Legalisasi"], stepsVerified: false },
];
